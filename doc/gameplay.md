...
あるプレイヤーの手番が終了する直前の他家の取り得る振る舞いを示す。

* 牌が切られた直後：手番以外全員
  * 鳴き：システムが非副露部分手牌と他家のハイテイでない捨牌を吟味する。
    * ポン：捨牌と同一の牌からなる対子が存在するとき宣言可能
    * 大明槓：捨牌と同一の牌からなる暗刻が存在するとき宣言可能
    * チー：捨牌が数牌で、それに対応する搭子が存在するとき宣言可能
  * 通常ロン：捨牌＋テンパイが和了形であり、かつ役があるとき宣言可能
* 副露の直後
  * 搶槓ロン：他家の加槓の直後に、加槓牌＋テンパイが自家の和了形であるとき宣言可能
...
* システムは立直成立者が 4 人かどうかをテストする。
  * 4 人いるならば四家立直流局例外を送出する。
* 下家の手番へ
